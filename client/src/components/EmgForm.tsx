  ...
  return (
    <Form {...form}>
      <form 
        ...
        className="glass-card rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 w-full max-w-lg mx-auto border border-blue-100 relative group h-[400px] md:h-[600px] flex flex-col justify-between gap-6"
      >
